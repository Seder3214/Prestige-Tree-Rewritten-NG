const SOFTCAPS = {
	...
	base_db_boost: {
		...
		info() { return "Starts at "+format(this.start)+"x, brought to the 32th root" },
	},
		th_2_2: {
		title: "Thoughts 2nd effect",
		type: "log",
	...
	th_3_2: {
		...
		mag: new Decimal(50),
		display() { return tmp.ne.thoughtEff3.gte(this.start) },
		info() { return "Starts at "+format(this.start)+"x, brought to the 50th root" },
	},
	th_1: {
		...
		info() { return "Starts at "+format(this.start)+"x, brought to the 5th root" },
	},
	mb_2: {
